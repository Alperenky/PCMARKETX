...
import com.example.pcmarketx.ui.profile.ChangePasswordScreen
...
import com.example.pcmarketx.ui.profile.AddressesScreen
import com.example.pcmarketx.ui.profile.ActiveOrdersScreen
import com.example.pcmarketx.ui.settings.SettingsScreen
...
fun AppNavigation(
    ...
    NavHost(
        ...
        composable(Routes.Home.route) {
            HomeScreen(
                ...
                navigateToActiveOrders = {
                    navController.navigate(Routes.ActiveOrders.route)
                }
            )
        }
        ...
        composable(Routes.EditProfile.route) {
            com.example.pcmarketx.ui.profile.EditProfileScreen(
                navigateUp = { navController.navigateUp() }
            )
        }
        ...
        composable(Routes.Addresses.route) {
            com.example.pcmarketx.ui.profile.AddressesScreen(
                navigateUp = { navController.navigateUp() }
            )
        }
        composable(Routes.ActiveOrders.route) {
            ActiveOrdersScreen(navigateUp = { navController.navigateUp() })
        }
